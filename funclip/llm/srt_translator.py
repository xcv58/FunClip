...
def translate_srt_to_english(srt_content, api_key=None, base_url=None, model="gpt-5-mini"):
    ...
    system_prompt = (
        ...
        "Rules:\n"
        "1. Translate each subtitle segment's text from Chinese to English.\n"
        "2. Keep translations CONCISE — each segment will be displayed as video subtitles. "
        ...
        "3. Do NOT change timestamps or subtitle index numbers.\n"
        "4. Preserve the original meaning and tone. Prefer clear, natural English over literal translation.\n"
        "5. For proper nouns, brand names, or technical terms already in English, keep them as-is.\n"
        "6. Output ONLY the translated SRT content. No markdown formatting (like ```srt), no comments, no explanations.\n"
        "7. Maintain natural spoken English rhythm suitable for on-screen reading."
    )
